...
gulp.task('watch', ['browser-sync', 'sprite', 'jade'], function() {
	gulp.watch('app/scss/**/*.scss', ['sass']); // Наблюдение за sass файлами в папке sass
	gulp.watch(['app/img/icons/**/*.png'], ['sprite']);
	gulp.watch('app/*.html', browserSync.reload); // Наблюдение за HTML файлами в корне проекта
	gulp.watch('app/jade/**/*.jade', ['jade']); // Наблюдение за jade файлами в корне проекта
...
gulp.task('build', ['clean', 'img', 'sass', 'jade'], function() {
